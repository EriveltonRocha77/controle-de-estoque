...
Este sistema foi feito para ser intuitivo e fácil de estender. Caso queira implementar novas ideias, adicionar novos idiomas ou refinar ainda mais o design, sinta-se à vontade para abrir uma issue ou enviar um pull request!
